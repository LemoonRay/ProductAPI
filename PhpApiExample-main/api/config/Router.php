...
class Router {
    ...
    private function defineRoutes() {
        $this->routes = [
            'GET' => [
                ...
                'products/getAll' => [ProductController::class, 'getAllProduct'],
                'products/getAllLatestProductPrice' => [ProductController::class, 'getLatestPriceOfTheProduct'],
            ],
        ];
    }
    ...
    private function convertToRegex(string $route): string {
        // Allow both numeric and alphanumeric IDs
